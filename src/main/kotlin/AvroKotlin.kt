...
object AvroKotlin {
  ...
  fun genericRecordToSingleObjectEncoded(record: GenericData.Record, genericData: GenericData = defaultLogicalTypeConversions.genericData): SingleObjectEncodedBytes {
